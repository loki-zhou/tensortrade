...
class BaseEnvironment(gym.Env):
    ...
    def seed(self, seed: int = 1):# deprecated: in favor of Env.reset(seed=seed).
    ...
    def reset(
        ...
        *,
        seed: int = 1,
        options = None,
    ):# -> 'np.array': # Does it have to return the an NP Array??
        """
    ...
    # Keeping around incase we want to start building more complex environment templates in the future.
