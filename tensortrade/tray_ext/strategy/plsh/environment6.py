...
# --- Custom Code --- #
# Data
from tensortrade.tray_ext.environments.sinewave.data import SineWaveDataGenerator
# Action Schemes
from tensortrade.tray_ext.tensortradeExtension.actions import get as getAction
# Reward Schemes
from tensortrade.tray_ext.tensortradeExtension.rewards import get as getReward
# Renderer
from tensortrade.tray_ext.tensortradeExtension.renderer.bsshPositionChangeChart import PositionChangeChart
from tensortrade.tray_ext.tensortradeExtension.renderer.emptyRenderer import EmptyRenderer
...
def generate_env(dataframe, config):
  ...
  # set reward scheme
  reward_scheme = getReward('short-networth-change')(starting_value = cash.balance.as_float())
  # set action scheme
